...
export async function generateMetadata({
  ...
  return {
    title: `${collection.name} - ${collection.category}`,
...
export default async function CollectionPage({
  ...
  return (
    <>
      <section className="shell pb-14 pt-36 lg:pt-44">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 font-display text-xl italic text-gold">{collection.tagline}</p>
