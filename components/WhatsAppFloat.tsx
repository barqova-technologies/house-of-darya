...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-13 w-13 items-center justify-center rounded-full bg-gold text-night shadow-lg shadow-night/20 transition-all duration-300 hover:scale-105 hover:bg-gold-soft"
    >
